...
import { ALCOHOL_PRESETS, KCAL_PER_STANDARD_GLASS } from '../data/presets';
import type { AlcoholEntry, MealEntry, Profile } from './types';
...
describe('macrodoelen', () => {
  ...
  it('houdt vet op minimaal 0,8 g/kg', () => {
    // Lage calorieën dwingen de ondergrens af.
