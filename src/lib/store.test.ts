...
import { getState, initialState, replaceState, subscribe, update } from './store';
...
describe('store — reactiviteit', () => {
  /*
   * useSyncExternalStore vergelijkt snapshots met Object.is. Een mutator die
   * de bestaande state aanpast zonder nieuwe root-referentie levert dus geen
   * re-render op: de data klopt dan wel, maar het scherm beweegt niet mee.
   */
