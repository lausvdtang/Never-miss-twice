export const EMPTY_TOTALS = { kcal: 0, proteinG: 0, carbsG: 0, fatG: 0 };
...
export function proteinRange(phase) {
...
export function macroTargets(profile) {
  ...
  const phaseNote = PHASE_DESCRIPTIONS[profile.phase];
...
export function proteinPerMeal(proteinG) {
...
export function sumAlcohol(entries) {
 ...
 */
export function eightyTwenty(meals, alcohol, weeklyKcalTarget) {
  let baseKcal = 0;
  let freeKcal = 0;
...
export function remaining(target, totals, alcoholKcal) {
  return {
