import { TREND_THRESHOLDS } from './presets.js';
import { daysBetween, isoWeekday, today as todayKey, weekKey } from './date.js';

/**
 * §8.6: maximaal 1× per week wegen, altijd onder dezelfde omstandigheden.
 * Vaker meten levert ruis op, geen signaal — de app moedigt het actief af.
 */
export function weighInGate(weighIns, weighInDay, today = todayKey()) {
 ...
 */
export function trend(weighIns, window = 4) {
...
export function trendInsight(weighIns, phase) {
...
export function bodyFatNote(bodyFatPct) {
  ...
  // Geen vaste decimaal: "4%" leest prettiger dan "4,0%".
